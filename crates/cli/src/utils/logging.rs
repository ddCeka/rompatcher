...
pub fn init(verbose: u8) {
    ...
    Builder::new()
        ...
        .filter_module("rompatcher", level)
        .filter_module("rompatcher_cli", level)
        .filter_module("rompatcher_core", level)
        .filter_module("rompatcher_features", level)
        .filter_module("rompatcher_formats", level)
