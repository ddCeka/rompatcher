...
use rompatcher_formats::xdelta::XdeltaPatcher;
...
const PATCH_BYTES: &[u8] =
    include_bytes!("../../../test_files/xdelta/patch.xdelta");
const ROM_BYTES: &[u8] =
    include_bytes!("../../../test_files/xdelta/test.rom.nds");
...
fn xdelta_apply(bencher: Bencher) {
    bencher.bench_local(|| {
        ...
        // content
        let _ = XdeltaPatcher
            .apply(divan::black_box(&mut rom), divan::black_box(PATCH_BYTES));
    });
}
