...
pub fn parse_file_metadata(
    ...
    match rom_type {
        ROM_TYPE_RAW | ROM_TYPE_NES | ROM_TYPE_FDS | ROM_TYPE_SNES
        | ROM_TYPE_N64 | ROM_TYPE_GB | ROM_TYPE_SMS | ROM_TYPE_MEGA
        | ROM_TYPE_PCE | ROM_TYPE_LYNX => {}
        _ => {
